...
<body>
<div class="image-container set-full-height" style="background-image: url('bootstrap-wizard-master/assets/img/wizard.jpg')">
    <!--   Creative Tim Branding   -->
    <a href="http://creative-tim.com">
         <div class="logo-container">
            <div class="logo">
                <img src="bootstrap-wizard-master/assets/img/new_logo.png">
            </div>
            <div class="brand">
                Creative Tim
            </div>
                ...
                <!--        You can switch ' data-color="orange" '  with one of the next bright colors: "blue", "green", "orange", "red"          -->
						...
						<div class="wizard-navigation">
                            <ul>
                                ...
                                <li><a href="#nour" data-toggle="tab">nour</a></li>
                            </ul>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="about">
                              <div class="row">
                                  <h4 class="info-text"> Let's start with connexion to Server and choose OlapCube</h4>
                                  <div class="col-sm-4 col-sm-offset-1">
                                     <div class="picture-container">
                                         <div class="picture">
                                              <img src="bootstrap-wizard-master/assets/img/default-avatar.png" class="picture-src" id="wizardPicturePreview" title=""/>
                                  ...
                                  <div class="col-sm-6">
                                      <div class="form-group">
                                        <label>Choose Server <small>(required)</small></label>
