...
<head runat="server">
    ...
    <link rel="stylesheet" href="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/vendors/font-awesome/css/font-awesome.min.css" />
    <link rel="stylesheet" href="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/vendors/bootstrap-datepicker/bootstrap-datepicker.min.css"/>
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.html"><img src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/images/logo.svg" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.html"><img src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/images/logo-mini.svg" alt="logo" /></a>
        </div>
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                <div class="nav-profile-img">
                  <img src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/images/faces/face28.png" alt="image">
                </div>
              ...
              <div class="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                <div class="p-3 text-center bg-primary">
                  <img class="img-avatar img-avatar48 img-avatar-thumb" src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/images/faces/face28.png" alt="">
                </div>
                <div class="p-2">
              ...
              <div class="dropdown-menu dropdown-menu-end navbar-dropdown preview-list" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/images/faces/face4.jpg" alt="image" class="profile-pic">
                  </div>
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/images/faces/face2.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <img src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/images/faces/face3.jpg" alt="image" class="profile-pic">
                  </div>
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="first.aspx">Buttons</a></li>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="auth">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/pages/samples/blank-page.html"> Blank Page </a></li>
                  <li class="nav-item"> <a class="nav-link" href="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/pages/samples/login.html"> Login </a></li>
                  <li class="nav-item"> <a class="nav-link" href="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/pages/samples/register.html"> Register </a></li>
                  <li class="nav-item"> <a class="nav-link" href="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/pages/samples/error-404.html"> 404 </a></li>
                  <li class="nav-item"> <a class="nav-link" href="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/pages/samples/error-500.html"> 500 </a></li>
                </ul>
              </div>
            </li>
      ...
      <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/vendors/js/vendor.bundle.base.js"></script>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/vendors/chart.js/Chart.min.js"></script>
    <script src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/vendors/jquery-circle-progress/js/circle-progress.min.js"></script>
    <script src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/js/jquery.cookie.js" type="text/javascript"></script>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/js/off-canvas.js"></script>
    <script src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/js/hoverable-collapse.js"></script>
    <script src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/js/misc.js"></script>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="ConnectPlusAdmin-Free-Bootstrap-Admin-Template-master/template/assets/js/dashboard.js"></script>
