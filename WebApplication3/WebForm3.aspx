<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="WebApplication3.display" %>
<!DOCTYPE html>
<html>
<head>
    ...
    <script>
        if (typeof jQuery == "undefined") {
            ...
            document.write(decodeURIComponent('%3Cscript src="Scripts/jquery-2.2.4.min.js" %3E%3C/script%3E'));
        }
    </script>
    ...
    <script>
        if (typeof kendo == "undefined") {
            ...
            document.write(decodeURIComponent('%3Clink rel="stylesheet" href="Content/kendo.blueopal.min.css" %3C/%3E'));

            // Fallback to local Kendo UI for jQuery scripts.
            document.write(decodeURIComponent('%3Cscript src="Content/kendo.all.min.js" %3E%3C/script%3E'));
                ...
                $(document).ready(function () {
                    ...
                    var dataSource = new kendo.data.TreeListDataSource({
                        data: [ 
                            ...
                            { id: 147155, Name: "Dailyname", Position: "cof", Phone: "(555) 4785125", parentId: null },

                            { id: 2, Name: "Guy Wooten", Position: "Chief Technical Officer", Phone: "(438) 738-4935", parentId: 1 },
                            { id: 785, Name: "nourkh", Position: "developer", Phone: "(438) 7845-985", parentId: 147155 },
